...
import (
	...
	informers "github.com/faizan82/controllers/cnat-controller/pkg/generated/informers/externalversions"
)
...
func main() {
	...
	controller := NewController(kubeClient, cnatClient, cnatInformerFactory.Cnatcontroller().V1alpha1().Ats(), kubeInformerFactory.Core().V1().Pods())
