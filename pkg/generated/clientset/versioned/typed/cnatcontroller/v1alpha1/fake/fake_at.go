...
type FakeAts struct {
	Fake *FakeCnatcontrollerV1alpha1
	ns   string
}

var atsResource = schema.GroupVersionResource{Group: "cnatcontroller.k8s.io", Version: "v1alpha1", Resource: "ats"}

var atsKind = schema.GroupVersionKind{Group: "cnatcontroller.k8s.io", Version: "v1alpha1", Kind: "At"}
