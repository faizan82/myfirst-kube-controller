...
import (
	...
	cnatcontrollerv1alpha1 "github.com/faizan82/controllers/cnat-controller/pkg/apis/cnatcontroller/v1alpha1"
	versioned "github.com/faizan82/controllers/cnat-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/faizan82/controllers/cnat-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/faizan82/controllers/cnat-controller/pkg/generated/listers/cnatcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CnatcontrollerV1alpha1().Ats(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CnatcontrollerV1alpha1().Ats(namespace).Watch(context.TODO(), options)
			},
		},
		&cnatcontrollerv1alpha1.At{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *atInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cnatcontrollerv1alpha1.At{}, f.defaultInformer)
}
